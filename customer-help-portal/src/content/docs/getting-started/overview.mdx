...
description: Learn what Analog Water does, how its components work together, and how to navigate the platform.
---

import { Steps, Tabs, TabItem, Aside } from '@astrojs/starlight/components';

Analog Water is a billing and property management platform built for water utility companies and property managers in East Africa. It brings together everything you need to run your operations — meter readings, billing cycles, mobile money payments, SMS notifications, and tenant management — in one connected system.

Whether you manage a small community water scheme or a large urban utility, the platform scales to fit your workflow.

## What Analog Water does

At its core, Analog Water solves three problems:
...
Analog Water is made up of three parts that work together seamlessly.
...
<Aside type="note">
Analog Water does not require any desktop software installation. The entire platform runs in your browser and on the mobile app.
</Aside>

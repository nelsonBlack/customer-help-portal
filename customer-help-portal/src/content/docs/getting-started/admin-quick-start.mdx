...
description: A step-by-step guide to setting up your company on Analog Water — from registration to your first bill.
---

import { Steps, Tabs, TabItem, Aside } from '@astrojs/starlight/components';

This guide walks you through everything you need to do to get your water utility company fully operational on Analog Water. By the end, you will have a configured billing system, your first customer on record, M-Pesa payments connected, and SMS notifications ready to send.
...
1. **Register your company**
   ...
   Go to [app.analogwater.com/register](https://app.analogwater.com/register) and fill in your company details:
   ...
   | **Country** | Select your country from the dropdown (e.g., Kenya). |
   | **Currency** | Choose your billing currency (e.g., KES for Kenyan Shilling). |
...
2. **Verify your email**
   ...
   Check your inbox for a verification email from Analog Water. Click the **Verify Email** button in the message to activate your account.
...
3. **Log in and explore the dashboard**
   ...
   Go to [app.analogwater.com](https://app.analogwater.com) and sign in with your admin email and password.
...
5. **Set up pricing and tariffs**
   ...
   Analog Water supports **tiered pricing**, which means you can charge different rates based on consumption bands. This is the standard model used by most Kenyan water utilities.

   Here is an example of a typical tariff structure:

   | Tier | Consumption range | Rate per unit (KES) |
   |---|---|---|
   | Tier 1 | 0 - 10 m3 | 50 |
   | Tier 2 | 11 - 30 m3 | 75 |
   | Tier 3 | 31 - 60 m3 | 100 |
...
7. **Add your first customer and meter**
   ...
   <Aside type="tip">
   If you are migrating from another system and need to add customers in bulk, contact support at support@analogwater.com. We can help you import your existing customer list from a spreadsheet.
   </Aside>
...
8. **Configure M-Pesa payment settings**
   ...
   | **Callback URL** | Auto-filled by Analog Water. Do not change this unless instructed by support. |
   ...
   <Aside type="note">
   Do not have a Safaricom paybill yet? You can apply for one at [safaricom.co.ke](https://www.safaricom.co.ke/business/sme/m-pesa-payment-solutions/lipa-na-m-pesa). The process typically takes 2-4 weeks. You can continue setting up everything else in the meantime.
   </Aside>
...
9. **Set up SMS notifications**
   ...
   Analog Water uses [Africa's Talking](https://africastalking.com) to send SMS messages to your customers. You will need an Africa's Talking account.
...
Congratulations — your company is now fully configured on Analog Water. Here is a quick summary of what you have done:
...
If you run into any issues during setup, email us at support@analogwater.com or use the in-app chat widget (bottom-right corner of the dashboard). Our support team is available Monday through Friday, 8:00 AM to 6:00 PM EAT.
</Aside>

...
description: Run billing cycles, understand bill calculations, review invoices, distribute bills via SMS and email, and handle adjustments in Analog Water.
---
...
Billing in Analog Water follows a predictable rhythm:
...
When a customer connects in the middle of a billing cycle, they should not be charged for the full period. Analog Water handles this with pro-rated billing.

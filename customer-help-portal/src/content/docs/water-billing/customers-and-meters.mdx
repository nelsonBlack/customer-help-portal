...
description: Add customers, assign meters, organize by region, and manage your entire customer database in Analog Water.
---

import { Steps, Tabs, TabItem } from '@astrojs/starlight/components';

Your customer database is the foundation of everything in Analog Water — billing, readings, payments, and reporting all flow from accurate customer and meter records. This guide covers how to add customers, assign meters, organize your service area, and keep your records clean over time.

## Adding a new customer

Every customer in Analog Water represents a single connection point — one household, business, or institution that receives water through a metered connection.
...
For utilities managing hundreds or thousands of customers, adding records one by one is impractical. Analog Water supports bulk import via CSV files.

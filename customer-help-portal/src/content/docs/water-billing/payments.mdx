...
![The Payments page showing transaction records](../../../assets/guides/payments-list.png)

## M-Pesa payment setup

M-Pesa is a popular mobile money payment method. EasyBiller integrates directly with the M-Pesa API to automatically match incoming payments to customer accounts.
...
![Payment detail showing transaction information](../../../assets/guides/payment-detail.png)
...
![The failed payments tab showing unprocessed transactions](../../../assets/guides/payments-failed-tab.png)
...
**Example:** A customer pays and has three unpaid invoices.

| Invoice | Amount Due | Payment Applied | Status After |
|---|---|---|---|
| January bill | (Amount A) | (Amount A) | Paid |
| February bill | (Amount B) | (Amount B) | Paid |
| March bill | (Amount C) | (Remaining amount) | Partial (balance remaining) |

The payment was distributed across invoices chronologically. The March bill shows a partial payment with a remaining balance.

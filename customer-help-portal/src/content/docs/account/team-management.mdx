...
description: Invite team members, assign roles, manage permissions, and control access across your Analog Water organization.
---

import { Steps, Tabs, TabItem } from '@astrojs/starlight/components';

Your Analog Water company account supports multiple team members, each with a specific role that controls what they can see and do. This guide covers how to manage your team from the dashboard.
...
<Tabs>
  <TabItem label="SuperAdmin">
    **Full platform access**
    ...
    SuperAdmin is a platform-level role. Most organizations have only one or two SuperAdmin accounts. This role should be reserved for the person responsible for the overall Analog Water deployment.
    :::
  </TabItem>
  <TabItem label="Admin">
    **Full company access**
...
- If the issue persists, the email domain may be blocking messages from Analog Water. Contact support for alternative delivery options.
